...
(()=>{var e=(()=>{"use strict";return e=>({case_insensitive:!0,name:"GSQL",
keywords:{
...
contains:[e.QUOTE_STRING_MODE,e.APOS_STRING_MODE,e.C_NUMBER_MODE,e.C_BLOCK_COMMENT_MODE,e.HASH_COMMENT_MODE,{
className:"clause",begin:/(\s+|,)\w+\(/,end:/\)/,keywords:{
built_in:"accum having limit order postAccum sample where"}}]})})()
;hljs.registerLanguage("gsql",e)})();